  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[330px,1fr]">
      <SectionCard>
        ...
        <h1 className="mt-2 text-[24px] font-bold tracking-tight text-text-primary">Filter Questions</h1>
        ...
        <form className="mt-5 space-y-3.5" onSubmit={applyFilters}>
          ...
          {loadingFilterOptions ? (
            <p className="text-[12px] text-neutral">Loading filter values...</p>
          ) : null}
        </form>
      </SectionCard>
      ...
      <SectionCard>
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="text-[12px] font-semibold uppercase tracking-widest text-neutral">Fetched Questions</p>
            <h2 className="mt-2 text-[24px] font-bold text-text-primary">Question List</h2>
          </div>
          <button
        ...
        <div className="mt-6 space-y-4">
          {loading ? <p className="text-[14px] text-neutral">Loading questions...</p> : null}
